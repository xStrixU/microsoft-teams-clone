...
export const EntryFormBox = ({ title, bottomSection, children }: EntryFormBoxProps) => (
	<div className="flex h-full w-full flex-col justify-center border-gray-300 dark:border-neutral-900 bg-neutral-background-default p-8 sm:h-fit sm:max-w-lg sm:rounded-2xl sm:border">
